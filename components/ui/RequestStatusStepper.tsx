import { formatDateTime, statusLabels, type RequestView } from './blood-request';

export default function RequestStatusStepper({ status, createdAt }: Pick<RequestView, 'status' | 'createdAt'>) {
